...
const Dashboard = () => {
  ...
  const sportsButton = [
    { url: 'https://cdn.mac1j.com/gstatic/gemexchimages/cricket-bg.png', name: 'cricket' },
    { url: 'https://cdn.mac1j.com/gstatic/gemexchimages/football-bg.png', name: 'football' },
    { url: 'https://cdn.mac1j.com/gstatic/gemexchimages/tennis-bg.png', name: 'tennis' },
    { url: 'https://cdn.mac1j.com/gstatic/gemexchimages/horse-bg.png', name: 'horse' },
    { url: 'https://cdn.mac1j.com/gstatic/gemexchimages/greyhound-bg.png', name: 'greyhound' },
  ];
    ...
    <div className='flex gap-4 overflow-hidden overflow-x-auto'>
      {props.sportsButton.map((i, index) => (
        <NavLink to={'/'} key={index} className='relative'>
          <img src={i.url} alt={index} className='w-[150px] h-[40px] object-cover rounded-lg' />
          <p className='top-3 absolute left-2 capitalize text-white font-semibold'>{i.name}</p>
        </NavLink>
      ))}
    </div>
  );
